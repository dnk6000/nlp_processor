...
class Cassandra_git300_scrap(PgDbCassandra):
    ...
    def upsert_data_text(self, id_data_html=0, id_project=0, id_www_sources=0, content='', content_header = '', content_date = const.EMPTY_DATE,
                                sn_id = None, sn_post_id = None, sn_post_parent_id = None, autocommit = True, **kwargs):
        @wrap.execute_with_query_plan_0
        def local(self, id_data_html=0, id_project=0,  id_www_sources=0,     content='', content_header='', content_date=None,
        ...
        res = local(self, id_data_html, id_project, id_www_sources, content, content_header, content_date,
                                sn_id, sn_post_id, sn_post_parent_id, autocommit = autocommit)
        return res
