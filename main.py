    ...
    for res_list in crawler.crawl_wall(16758516):
        ...
        for res_unit in _res_list:
            ...
            if res_unit['result_type'] == const.CW_RESULT_TYPE_NUM_SUBSCRIBERS:
                ...
                cass_db.add_to_db_log_crawling(id_project, "ERROR", res_unit['result_type'], res_unit['datetime'], res_unit['err_description'])
                break
            elif res_unit['result_type'] == const.CW_RESULT_TYPE_FINISH_SUCCESS:
                cass_db.add_to_db_log_crawling(id_project, "INFO", res_unit['result_type'], res_unit['datetime'], res_unit['err_description'])
